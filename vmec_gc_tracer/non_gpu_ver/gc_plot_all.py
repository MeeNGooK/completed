...
datnum=10    # make sure dat file name is formatted as 'dat1.dat', 'dat2.dat', ...
cutter=10
mode=6 
nc_filename= 'wout_iota0_42.nc'
...
def datagetter_cut(file_path2,cut):
    data = np.loadtxt(file_path2, skiprows=9)
...
file_path = os.path.join(os.path.dirname(__file__), nc_filename)
