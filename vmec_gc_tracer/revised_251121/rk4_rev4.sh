...
if [ $compile_status -eq 0 ]; then
  ...
  echo ">>> Running with arguments: 5.0e5 3.4e6 '$outfile' 1.0e-9 5000000 100 1 wout_iota0_42.nc"
  ./"$OUTFILE" 5.0e5 3.4e6 "$outfile" 1.0e-10 5000000 100 1 wout_iota0_42.nc
